...
byte data1[10] = {"PussyPussy"};  //The first data that needs to be written to the tag.
byte data2[10] = {"PenisPenis"};  //The second data that needs to be written to the tag.
